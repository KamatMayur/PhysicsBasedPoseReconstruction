...
def vscale(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def expandload(result, base, indices, mask, pass_thru, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def extractelement(vector, *, position=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def extract(vector, dynamic_position, static_position, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def extract_strided_slice(result, vector, offsets, sizes, strides, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def fma(lhs, rhs, acc, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def flat_transpose(res, matrix, rows, columns, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def gather(result, base, indices, index_vec, mask, pass_thru, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def insertelement(source, dest, *, position=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def insert(source, dest, dynamic_position, static_position, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def insert_strided_slice(source, dest, offsets, strides, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def load(result, base, indices, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def maskedload(result, base, indices, mask, pass_thru, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def matrix_multiply(res, lhs, rhs, lhs_rows, lhs_columns, rhs_columns, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def multi_reduction(kind, source, acc, reduction_dims, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def print_(*, source=None, punctuation=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(PrintOp(source=source, punctuation=punctuation, loc=loc, ip=ip))
...
def reshape(result, vector, input_shape, output_shape, fixed_vector_sizes, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def scalable_extract(res, source, pos, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def scalable_insert(source, dest, pos, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def scan(kind, source, initial_value, reduction_dim, inclusive, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def shuffle(v1, v2, mask, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def transfer_read(vector, source, indices, permutation_map, padding, *, mask=None, in_bounds=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def transfer_write(result, vector, source, indices, permutation_map, *, mask=None, in_bounds=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def transpose(result, vector, transp, *, loc=None, ip=None) -> _ods_ir.OpResult:
