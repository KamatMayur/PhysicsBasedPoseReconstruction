...
def all_reduce(result, operand, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def all_to_all(operand, split_dimension, concat_dimension, split_count, replica_groups, *, channel_handle=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def concatenate(inputs, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def custom_call(result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None) -> _ods_ir.OpResult:
