...
def abs(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def add_dependency(operand, token, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def add(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def after_all(inputs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def all_gather(result, operand, all_gather_dim, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def all_reduce(result, operands_, replica_groups, *, channel_handle=None, use_global_device_ids=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def all_to_all(operand, replica_groups, *, split_dimension=None, concat_dimension=None, split_count=None, channel_handle=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def and_(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def async_done(bundle, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def async_start(result, inputs, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def async_update(bundle, called_computation, execution_thread, *, group_id=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def atan2(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def batch_norm_grad(operand, scale, mean, variance, grad_output, epsilon, feature_index, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def batch_norm_inference(operand, scale, offset, mean, variance, epsilon, feature_index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def batch_norm_training(operand, scale, offset, epsilon, feature_index, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def broadcast(operand, broadcast_sizes, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def case(result, index, num_branches, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def cbrt(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def ceil(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def cholesky(a, *, lower=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def clamp(min, operand, max, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def count_leading_zeros(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def collective_permute(operand, source_target_pairs, *, channel_handle=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def compare(lhs, rhs, comparison_direction, *, compare_type=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def complex(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def compute_reshape_shape(result, num_elements, dynamic_shape, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def concatenate(val, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def copy(operand, *, cross_program_prefetch_index=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def cosine(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def create_token(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def cross_replica_sum(operand, replica_groups, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def cstr_reshapable(num_elements, dynamic_shape, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def custom_call(result, inputs, call_target_name, *, has_side_effect=None, backend_config=None, api_version=None, called_computations=None, custom_call_schedule=None, operand_layouts=None, result_layouts=None, output_operand_aliases=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def divide(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def domain(operand, kind, entry_metadata, exit_metadata, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dot_general(result, lhs, rhs, dot_dimension_numbers, *, precision_config=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dynamic_gather(operand, start_indices, slice_sizes, dimension_numbers, *, indices_are_sorted=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dynamic_slice(operand, start_indices, slice_sizes, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def dynamic_update_slice(operand, update, start_indices, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def exponential(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def exponential_minus_one(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def fft(operand, fft_type, fft_length, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def floor(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
  ...
  def __init__(self, results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None):
    ...
    if output_operand_aliases is not None: attributes["output_operand_aliases"] = (output_operand_aliases if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_731')) else
          _ods_ir.AttrBuilder.get('anonymous_731')(output_operand_aliases, context=_ods_context))
...
def fusion(results_, inputs, *, fusion_kind=None, output_operand_aliases=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def gather(operand, start_indices, dimension_numbers, slice_sizes, *, indices_are_sorted=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def get_dimension_size(operand, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def get_tuple_element(operand, index, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def if_(result, pred, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def imag(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def infeed(result, token, *, infeed_config=None, layout=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def is_finite(x, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def log_plus_one(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def log(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def logistic(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def maximum(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def minimum(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def multiply(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def negate(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def not_(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def optimization_barrier(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def or_(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def outfeed(inputs, token, *, outfeed_config=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def pad(operand, padding_value, edge_padding_low, edge_padding_high, interior_padding, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def partition_id(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def popcnt(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def power(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def real(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def recv(result, token, channel_handle, *, is_host_transfer=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def reduce(result, inputs, init_values, dimensions, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def reduce_precision(operand, exponent_bits, mantissa_bits, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def reduce_window(result, inputs, init_values, window_dimensions, *, window_strides=None, base_dilations=None, window_dilations=None, padding=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def remainder(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def replica_id(*, loc=None, ip=None) -> _ods_ir.OpResult:
...
def reverse(operand, dimensions, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def rng_bit_generator(output_state, output, rng_algorithm, initial_state, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def rng(a, b, shape, rng_distribution, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def round_nearest_even(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def round_nearest_afz(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def rsqrt(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def scatter(result, inputs, scatter_indices, updates, scatter_dimension_numbers, *, indices_are_sorted=None, unique_indices=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def select(pred, on_true, on_false, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def send(inputs, token, channel_handle, *, is_host_transfer=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def set_dimension_size(operand, size, dimension, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def shift_left(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def shift_right_arithmetic(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def shift_right_logical(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def sign(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def sine(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def slice(operand, start_indices, limit_indices, strides, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def sort(result, inputs, *, dimension=None, is_stable=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def sqrt(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def subtract(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tan(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tanh(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def topk(values, indices, operand, k, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
  return _get_op_result_or_op_results(TopKOp(values=values, indices=indices, operand=operand, k=k, loc=loc, ip=ip))
...
def transpose(operand, permutation, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def triangular_solve(a, b, left_side, lower, unit_diagonal, transpose_a, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def tuple(val, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def uniform_dequantize(operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def while_(result, operand, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def xla_rng_get_and_update_state(delta, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def xor(lhs, rhs, *, loc=None, ip=None) -> _ods_ir.OpResult:
