...
def assemble(result, values, levels, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def compress(values, filled, added, count, tensor, lvl_coords, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def disassemble(ret_values, ret_levels, val_len, lvl_lens, tensor, out_values, out_levels, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def expand(values, filled, added, count, tensor, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def foreach(results_, tensor, init_args, *, order=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def storage_specifier_get(specifier, specifier_kind, *, level=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def insert(value, tensor, lvl_coords, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def load(tensor, *, has_inserts=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def number_of_entries(tensor, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def push_back(cur_size, in_buffer, value, *, n=None, inbounds=None, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
...
def reduce(x, y, identity, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def select(x, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def storage_specifier_set(specifier, specifier_kind, value, *, level=None, loc=None, ip=None) -> _ods_ir.OpResult:
...
def coordinates_buffer(result, tensor, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def coordinates(result, tensor, level, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def positions(result, tensor, level, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def slice_offset(slice, dim, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def slice_stride(slice, dim, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def values(result, tensor, *, loc=None, ip=None) -> _ods_ir.OpResult:
