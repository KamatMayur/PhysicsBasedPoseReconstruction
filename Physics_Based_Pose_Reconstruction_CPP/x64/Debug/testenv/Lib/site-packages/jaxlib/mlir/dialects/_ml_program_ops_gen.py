...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, arg_attrs=None, res_attrs=None, sym_visibility=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_387')) else
      _ods_ir.AttrBuilder.get('anonymous_387')(function_type, context=_ods_context))
...
def global_load_graph(result, produce_token, global_, consume_tokens, *, loc=None, ip=None) -> _Sequence[_ods_ir.OpResult]:
