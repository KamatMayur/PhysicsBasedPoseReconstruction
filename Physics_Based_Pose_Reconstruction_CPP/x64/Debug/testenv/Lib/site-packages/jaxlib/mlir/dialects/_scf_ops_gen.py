...
def execute_region(result, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def index_switch(results_, arg, cases, num_case_regions, *, loc=None, ip=None) -> _ods_ir.OpResult:
...
def while_(results_, inits, *, loc=None, ip=None) -> _ods_ir.OpResult:
